...
async function applyFix() {
  try {
    console.log("📦 Reading utility settings migration file...");
    const migrationPath = path.join(__dirname, "../database/20260225_add_utility_settings.sql");
    ...
    if (error) {
      ...
      console.log("3. Paste the content of: database/20260225_add_utility_settings.sql");
      console.log("4. Click RUN");
      process.exit(1);
    }

    console.log("✅ Utility settings table created successfully via RPC!");
    process.exit(0);
