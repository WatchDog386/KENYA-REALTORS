...
import { ClipboardCheck, Search, Loader2, CheckCircle, Clock, XCircle, Home, MapPin, DollarSign, User, Phone, Mail, Trash2 } from 'lucide-react';
              ...
              <CardContent className="pt-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="pl-0 md:pl-6 border-t md:border-t-0 md:border-l pt-4 md:pt-0">
                        ...
                        <Button variant="destructive" size="icon" onClick={() => handleDelete(app.id)} disabled={updatingId === app.id} className="mt-2 w-full"><Trash2 className="w-4 h-4 mr-2" /> Delete</Button>
                    </div>
                </div>
                 {app.notes && (
