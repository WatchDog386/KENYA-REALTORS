...
interface Notification {
  ...
  time: string;
  read: boolean;
  type: 'system' | 'message' | 'report' | 'maintenance';
  created_at: string;
}

const CaretakerLayout = ({ children }: { children?: ReactNode }) => {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      case 'maintenance': return <Wrench size={14} className="text-red-500" />;
  ...
  useEffect(() => {
    ...
    const subscription = supabase
      .channel('caretaker-notifications')
      .on(
        'postgres_changes',
        {
          event: '*',
  ...
  const navItems: NavItem[] = [
    {
      title: 'Dashboard',
      href: '/portal/caretaker',
      icon: <LayoutDashboard size={20} />,
      description: 'Overview of your tasks'
    },
    {
      title: 'Maintenance',
      href: '/portal/caretaker/maintenance',
      icon: <Wrench size={20} />,
      description: 'Manage repair requests'
    },
    {
      title: 'My Property',
      href: '/portal/caretaker/property',
  ...
  // Load custom fonts and styles (same as ProprietorLayout)
  useEffect(() => {
    ...
    <div className="adminlte-shell wrapper min-h-screen bg-white text-[#154279] font-nunito selection:bg-blue-100 selection:text-blue-900" style={{ fontFamily: "'Nunito', sans-serif" }}>
      ...
      >
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left hidden md:block">
                  ...
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Caretaker</p>
                </div>
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-2xl border border-slate-200 z-50">
                    ...
                    <div className="p-2">
                       {/* Temporarily pointing to settings/dashboard as placeholders */}
                      <Link
                        to="/portal/caretaker"
        ...
        <div className="adminlte-content-surface flex-1 overflow-x-hidden custom-scroll bg-slate-50">
          <div className="adminlte-content-inner w-full">
            <Outlet />
          </div>
        </div>
      </main>
